...
| M2 全文字翻譯（4730 text + 1797 script） | 🔄 進行中：qog-2 複用 44%(2921)、核心批 01~04 定調通過(覆蓋 52%)、batch-05~28 全量 fan-out 中 |
| M3 baked-art 重繪（標題/credits/UI） | ⏳ 待做 |
| M4 打包 + Release（AppImage/Windows/macOS） | ⏳ 待做 |
